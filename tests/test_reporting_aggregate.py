import json
from cotpersona.reporting.aggregate import aggregate_results, flatten_metrics
from cotpersona.reporting.tables import write_tables
from cotpersona.reporting.figures import write_caption, write_figures
