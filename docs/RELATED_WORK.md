...
This note situates **Does Chain-of-Thought Prefer a Different Persona** against the mentor-linked literature for
[Does Chain-of-Thought Prefer a Different Persona](https://github.com/alanasung/cot-persona-drift).

## Positioning

Compare persona markers in final answers versus intermediate reasoning traces.

The design hypothesis is: Compare persona markers in final answers versus intermediate reasoning traces.
