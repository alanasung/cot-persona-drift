"""Experiment stages for Does Chain-of-Thought Prefer a Different Persona."""
...
from .cotpersona._util import ensure_dir, stage_result, write_json
...
def stage_report(cfg: DictConfig, run_dir: Path) -> dict[str, Any]:
    ...
    write_json(out / "report.json", {"headline": "Does Chain-of-Thought Prefer a Different Persona", "claims_gated": True})
