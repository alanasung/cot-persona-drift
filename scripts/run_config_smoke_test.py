...
def _compose(preset: str | None, overrides: list[str]):
    from cotpersona.configs.loader import load_config
...
def _smoke_one(preset: str | None, args: argparse.Namespace) -> int:
    from cotpersona.configs.loader import save_resolved_config
    from cotpersona.utils.git import git_state
...
def main(argv: list[str] | None = None) -> int:
    ...
    from cotpersona.configs.loader import available_presets
