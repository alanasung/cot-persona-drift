...
from cotpersona.configs.loader import register_schema
...
def _load_stage_registry(package: str = "cotpersona") -> dict:
...
def _run_stages(cfg: DictConfig, run_dir: Path) -> dict:
    ...
    if unavailable:
        ...
        print(f"      in cotpersona.stages: {unavailable}")
...
def main(cfg: DictConfig) -> None:
    ...
    from cotpersona.configs.loader import config_to_dict, save_resolved_config
    from cotpersona.models.device import get_device
    from cotpersona.utils.logging import configure_logging
    from cotpersona.utils.reproducibility import set_seed
    from cotpersona.utils.run_manifest import create_run_dir, save_run_metadata
